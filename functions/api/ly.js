...
export async function onRequestPost({ request, env }) {
  ...
  if (body.opts && typeof body.opts === 'object') {
    ...
    if (typeof body.opts.font === 'string' && ['gothic', 'serif', 'nanum', 'pen', 'paper', 'pretendard', 'barun', 'plex', 'jua', 'gowun'].includes(body.opts.font)) o.font = body.opts.font;   // paper = 페이퍼로지(레포 동봉 · 260805)
