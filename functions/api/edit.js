...
export async function onRequestPost({ request, env }) {
  ...
  const STR = { lang: ['auto', 'ko', 'dual', 'src'], tone: ['sns', 'plain'], style: ['bold', 'clean', 'box'], cutlv: ['soft', 'std', 'hard'],
    vid_ar: ['9:16', '1:1', '4:5', '16:9'], vid_fit: ['crop', 'pad', 'blur'], vid_res: ['src', '1080', '720'], vid_fps: ['60i', '30', '24'] };   // vid_res 'src' = 원본 유지(4K 캡 3840 · 260711) · '1080' = **목표**(작으면 확대 · 260809 — 구판은 전 값이 상한이라 640×360에 1080p를 골라도 무동작이었다) · vid_fit 'blur' = 원본 블러 확대 배경 여백(260711)
