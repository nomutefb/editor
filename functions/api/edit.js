...
export async function onRequestPost({ request, env }) {
  ...
  const STR = { lang: ['auto', 'ko', 'dual', 'src'], tone: ['lit', 'plain', 'sns', 'mz'],   // tone = 의역 강도 4단(운영자 260812 "직역 기본 의역 MZ어" · 편집 탭 기본 선택 = lit 직역 — 운영자 260923 · 결측 폴백 = 러너 sns) — 여기 없는 값은 러너까지 못 가고 조용히 기본으로 떨어진다
