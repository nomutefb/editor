...
**텍스트**
```text
앤트로픽이 10일 보고서에서 지목한 건
*중국 연구소 7곳, 약 2억 건의 증류였다*
알리바바는 1억5,100만 건을 훈련에 썼다
