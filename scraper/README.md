...
- 260923 정리: 국민일보 9피드 주소 이전(`www.kmib.co.kr/rss/data/`) · 시사인은 구 주소 8개가 2022~23년에 멈춰 CDN 전체기사 1개로 교체 ·
  응답 없음·빈 피드·1년 넘게 멈춘 섹션 제거(한경·이데일리·노컷·스포티비·시사저널 Health/Culture·경향 연예/IT/생활레저·여성신문 스포츠/연예·통일뉴스 북미관계).
- 추가: 방송(JTBC 속보·주요 · MBN · 연합뉴스TV) · 서울경제 · 연합 연예/문화/북한 · 외신 영문(NYT World · France24 · DW · Sky News).
- 미확보(피드 없음·403): KBS · YTN · 뉴스1 · 한국일보 · 중앙일보 · 한경. 노컷 신주소(`rss.nocutnews.co.kr`)는 발행시각이 깨져 보류.
- 영문 제목 클러스터링은 기능어를 거르고 문턱을 올린다(`EN_STOPWORDS` · `EN_MIN_OVERLAP` = `knews_scraper.py`). 한글 제목 규칙은 그대로.
