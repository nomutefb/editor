...
- **메이저급 판별** = **2006년 이후 방송3사(KBS·MBC·SBS) 연기대상·연예대상 또는 청룡영화상에서 '우수상급 이상'(대상·최우수·우수·남녀 주연/조연 등) 수상 이력**이 있는
  배우·방송인, 또는 그에 준하는 전국적 인지도(국민 대부분이 이름을 아는 배우·가수·방송인). ⚠️ 신인상·인기상·협찬상·커플상만 받은 것으로는 부족.
