...
⚠️ 단 해외라도 **사망·붕괴·매몰·지진해일 내습 등 실제 피해가 제목에 명시**되면 이 문턱 미적용 — 위 일반 규칙으로 판정.
  예) "[속보] 경주 인근 규모 5.2 지진" → O · "규모 3.8 지진…서울서도 진동" → O
  예) "일본 규모 5.2 지진…쓰나미 우려 없어" → X · "대만 규모 4.9 지진" → X · "캄차카 지진 발생" → X
  예) "튀르키예 규모 7.1 강진" → O · "필리핀 규모 5.4 지진에 건물 붕괴·12명 사망" → O
...
- 해외 지진 중 규모 6.0 미만·규모 미명시 — 실제 피해(사망·붕괴·지진해일 내습) 명시 없는 것 (🌏 게이트 · 국내는 3.5 이상 O)
