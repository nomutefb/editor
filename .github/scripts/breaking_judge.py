...
② 컴백·신작·수상·화보·근황·완전체·콘서트 등 활동 소식 ③ **열애·결별·결혼·이혼**(지위 변동 아님 — grade [3]이어도 긴급 X 유지)
...
(**다수·동시다발** 온열질환/한랭질환 사상·대규모 대피·단수·정전·산불·붕괴·고립·침수/범람·홍수·산사태 등 2차 사건 —
개별 온열·한랭질환 사상은 위 규칙대로 X 유지).
