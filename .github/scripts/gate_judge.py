...
⚠️ 경제 경중 = **행위 주체의 공·사**로 갈라라: 공적 주체(정부·국회·법원·규제기관·중앙은행·해외 정부)의 행위·제재·정책·개입, 국가 단위 공식 통계의 기록(경상수지·수출입·고용), 다수 시민 피해 현안 = [2]. 사적 주체(개별 기업·은행·매체·시장)의 자기 활동 — 실적·수주·입찰·지분 매각·신사업·개별 상품·금리·판매 중단·노사 임금 타결·기술 성과 — 은 규모·'역대 최대'·'세계 1위' 수식과 무관 [1]이고, 인수합병급도 [2] 경계선이다(운영자: "카카오 인수 정도는 2도 아슬아슬"). 기업이 주어라도 '벌어진 사건'(전면 파업 선언·대형 분쟁·논란·유명 기업인 사법)은 그 성격대로 [2]. 언론사(외신 포함)의 단독 **분석·전망·전언** 기사도 [1] — 뉴스를 만든 주체(기관 행위)면 [2], 논평·전달하는 주체(매체)면 [1](예: 'WSJ "美 엔화 방어…"' 분석 = [1] / '"모즈타바 위독"…반체제 매체 보도' 전언 = [1]). ⚠️ **매체명이 주어로 서 있을 때만 전언이다** — 제목의 주어가 정부·중앙은행·규제기관이고 그 기관이 **실제로 한 행위가 확정 서술**되면(개입·매각·방어·제재 실행 등), 그 사실을 어느 매체가 처음 알렸든 **기관 행위 = [2]**(다른 공적 주체의 공식 반응이 붙으면 더 분명하다). 예: '유로화 팔아 엔화 방어한 美…ECB "뒤늦게 알아 당혹"'(美 당국의 실행 + ECB 공식 반응) = [2] / 'WSJ "美, 엔화 방어 나설 듯"'(매체 주어·전망) = [1]. ⚠️ 단 지금 진행 중인 국가적 현안·정치 쟁점을 정면으로 다루는 **사설·칼럼**은 매체 견해여도 그 현안의 경중대로 — 살아있는 쟁점에 붙는 논평은 그 쟁점의 일부다(예: '[사설] 서울 40도…폭염 인프라 재설계' = [2] / '[사설] 대통령 육사 쿠데타 발언' = 진행 중 정치 쟁점 = [2]).
