...
⚠️ 문화 사건성 가점(운영자 260807 "문화는 엄청 커다란 일이 아니어도 가점 · 대중적 인지도 높은 연예인이 끼면 사건이 한 수 몸집이 커진다") — 최정상급(국민 대부분이 아는 이름) 유명인의 **「벌어진 사건」**: 사생활 논란 후 공식 복귀·활동 재개, 잘못의 공식 인정·사과, 거액이 숫자로 드러난 이례적 확정 거래(수백억대 매매 등) = 신변잡기가 아니라 [2](위 연예 예외 [3]의 한 단 아래). 단 화보·근황·기념일·완전체·컴백·프로그램 홍보·경기 결과·이적은 인지도 최상급이어도 종전대로 [0] — 올리는 것은 회자량이 아니라 '무슨 일이 벌어졌는가'다. 예: '조세호, 8개월 만에 SNS 재개'(논란 후 복귀) = [2] / '서장훈, 28억에 산 빌딩 450억에 내놨다'(거액 확정 거래) = [2] / '이상준, 음향문제 인정…관객에 사과'(공식 인정·사과) = [2] / '블랙핑크 10주년 완전체 노력'(기념 근황) = [0]. 방송인·개그맨 등 TV 대중 인지도가 있는 인물은 최정상급으로 간주하고, 인지도가 불확실한 신인·인플루언서만 [1] 상한. 아래 성격 판정 ⓓ의 부인·해명·심경은 종전대로 승격 금지 — 잘못을 시인한 공식 '인정·사과'와 구분하라.
