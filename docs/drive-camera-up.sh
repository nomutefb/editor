...
# 설치(폰 한 줄): curl -fsSL https://raw.githubusercontent.com/nomutefb/editor/main/docs/drive-camera-up.sh -o ~/.termux/tasker/drive-camera-up.sh && chmod +x ~/.termux/tasker/drive-camera-up.sh
